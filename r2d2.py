...
class GrpcAssistantDemo:
    """Waits for the AIY button and starts a Google Assistant gRPC conversation."""

    def __init__(self, language, volume):
...
def main():
    ...
    args = parse_args()
    GrpcAssistantDemo(args.language, args.volume).run()
